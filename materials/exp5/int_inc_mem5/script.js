...
function goBackToProlific() {
    window.location.replace("https://app.prolific.co/submissions/complete?cc=276299C3"); //redirect back to prolific
}
jatos.submitResultData(resultJson).then(jatos.endStudyAjax).then(goBackToProlific);
}
  },
  "files": {},
  "responses": {},
...
//shuffle list 3 for recognition testing
window.word1_test3 = window.word1_list3
window.word2_test3 = window.word1_list2
...
window.test_old_position = ["left","left","left","left","left","left","left","left","left","left","left","left","left","left","left","right","right","right","right","right","right","right","right","right","right","right","right","right","right","right"]


// shuffle
window.condition_list1 = this.random.shuffle(window.condition);
window.condition_list2 = this.random.shuffle(window.condition);
window.condition_list3 = window.condition_list2;
window.old_position_test3 = this.random.shuffle(window.test_old_position)
      ...
      "content": [
        {
          ...
          "strokeWidth": 1,
          "fill": "black",
          "text": "The test for this list has changed! Please read these instructions carefully!\n\nOn each screen you will see two words next to each other. \nOne of the words will be from the list you just studied.\nThe other word is from the second list.\n\nFor each pair, please respond which of the two words you remember seeing in the list you just studied!\n\nIf you think that the word on the left is from the last list, \npress the left (←) arrow key. \n\nIf you think that the word on the right is from the last list,\npress the right (→) arrow key.\n\nPlease try to do the task as accurately as possible.\n\nAll words previously shown in RED and BLUE will be tested. \nIf you remember a word, respond with the correct key regardless \nof whether you were asked to remember it before!\n\nPress \u003CSPACE\u003E to continue.",
          "fontStyle": "normal",
          "fontWeight": "normal",
          "fontSize": "16",
          "fontFamily": "sans-serif",
          ...
          },
          {
            ...
            "content": [
              ...
              },
              {
                ...
                "strokeWidth": 1,
                "fill": "black",
                "text": "Which word did you see in the last list?\nPress ← or →",
                "fontStyle": "normal",
                "fontWeight": "normal",
                "fontSize": "24",
                "fontFamily": "sans-serif",
...
// old word on the left or right
window.trial_old_position = window.old_position_test3[CounterTest3]

if (trial_old_position == "left") {
  window.myWord1 = window.word1_test3[CounterTest3]
  window.myWord2 = window.word2_test3[CounterTest3]
} else {
  window.myWord1 = window.word2_test3[CounterTest3]
  window.myWord2 = window.word1_test3[CounterTest3]
}

//save data
this.data.tested_word_left = myWord1
this.data.tested_word_right = myWord2
},
              "end": function anonymous(
) {
window.fast = this.data.duration
...
var showMyCounter = CounterTest3;
CounterTest3++
