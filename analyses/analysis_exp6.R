...
memdat <- read.csv('data/exp6/preproc_mem_data.csv')
mathdat <- read.csv('data/exp6/preproc_math_data.csv')
...
ggsave('figures/exp6_recall_by_list_and_condition.png', width=6.5, height=3, units='in')
...
ggsave('figures/exp6_studyRTs_by_list_and_condition.png', width=6.5, height=3, units='in')
...
memdat %>% 
  ...
  theme_bw() +
  ggtitle('Experiment 6')
ggsave('figures/exp6_studyRTs_by_current_and_previous_item_instructions.png', width= 5, height=3, units='in')
...
memdat %>% 
  ...
  ggtitle('Experiment 6') +
  theme_bw()
ggsave('figures/exp6_acc_f(studyRTs).png', width=4, height=3, units='in')
